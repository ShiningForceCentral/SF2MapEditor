...
import static com.sfc.sf2.map.io.PngManager.writeMapLayoutFlagsFile;
...
public class GifManager {
    ...
    public static void exportGifMapLayout(MapPanel mapPanel, String filepath, String flagsPath, String hpTilesPath){
        try {
            System.out.println("com.sfc.sf2.map.io.PngManager.exportPng() - Exporting GIF file ...");
            writeGifMapLayoutFile(mapPanel,filepath);   
            writeMapLayoutFlagsFile(mapPanel.getMap().getLayout(),flagsPath); 
            writeMapHpTilesFile(mapPanel.getMap().getLayout(),hpTilesPath);    
            System.out.println("com.sfc.sf2.map.io.PngManager.exportPng() - GIF file exported.");
        } catch (Exception ex) {
